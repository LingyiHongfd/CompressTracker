...
from lib.models.compresstracker.vit_compress_test import vit_base_patch16_224_compress_test
from lib.utils.box_ops import box_xyxy_to_cxcywh


class CompressTrackerTest(nn.Module):
    """ This is the base class for CompressTracker """

    def __init__(self, transformer, box_head, aux_loss=False, head_type="CORNER", sup_dict=None):
...
def build_compresstracker_test(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_compress':
        backbone = vit_base_patch16_224_compress_test(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
