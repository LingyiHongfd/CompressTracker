...
"""
Add default config for CompressTracker.
"""
cfg = edict()
...
cfg.MODEL.BACKBONE.PRETRAIN_FILE = "mae_pretrain_vit_base.pth"
...
cfg.MODEL.BACKBONE.DISTILL_LAYER = 4 # distill layer for distillation
...
# TRAIN.DISTILL
cfg.TRAIN.SUP_LOGIT = False  # logit supervision for each block
cfg.TRAIN.SUP_FEAT = False  # feature supervision for block
cfg.TRAIN.SUP_REPLACE = False  # replace supervision for each block
